	...
	<div class="wrapper">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li <c:if test="${page eq 'userList' }">class="active"</c:if>><a
						href="./admin?page=userList"><i class="fa fa-link"></i> <span>用户列表</span></a></li>
					<li <c:if test="${page eq 'itemList' }">class="active"</c:if>><a
						href="./admin?page=itemList"><i class="fa fa-link"></i> <span>商品列表</span></a></li>
					<li <c:if test="${page eq 'categoryList' }">class="active"</c:if>><a
						href="./admin?page=categoryList"><i class="fa fa-link"></i> <span>项目列表</span></a></li>
					<li <c:if test="${page eq 'orderList' }">class="active"</c:if>><a
						href="./admin?page=orderList"><i class="fa fa-link"></i> <span>订单列表</span></a></li>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<c:choose>
					<c:when test="${page eq 'userList' }">
						<%@include file="include/admin/userList.jsp"%>
					</c:when>
					<c:when test="${page eq 'itemList' }">
						<%@include file="include/admin/itemList.jsp"%>
					</c:when>
					<c:when test="${page eq 'orderList' }">
						<%@include file="include/admin/orderList.jsp"%>
					</c:when>
